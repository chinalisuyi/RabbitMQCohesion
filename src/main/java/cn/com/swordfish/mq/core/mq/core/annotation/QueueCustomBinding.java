package cn.com.swordfish.mq.core.mq.core.annotation;
...
public @interface QueueCustomBinding {
	 ...
	 * @return the queue.
	 */
	QueueCustom value() default @QueueCustom(value = RabbitConfig.DEFAULT_QUEUE, durable = "true");

	/**
	 * @return the exchange.
	 */
	Exchange exchange() default @Exchange(value = RabbitConfig.DEFAULT_EXCHANGE, type = ExchangeTypes.DIRECT);
